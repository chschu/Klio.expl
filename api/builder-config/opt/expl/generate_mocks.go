...
//go:generate go run github.com/golang/mock/mockgen@v1.6.0 -source webhook/entry_list_stringer.go  -destination generated/webhook_mocks/entry_list_stringer.go  -package webhook_mocks
